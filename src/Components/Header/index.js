    ...
    <header className="text-gray-600 body-font shadow">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <Link to={'/'} className="flex cursor-pointer title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <span className="ml-3 text-xl">Hybrid Ecomm</span>
        </Link>
        ...
        <button className="inline-flex items-center bg-red-200 border-0 py-1 px-3 focus:outline-none hover:bg-red-400 rounded text-base mt-4 md:mt-0">
          Go to Cart
          <svg
            fill="none"
            stroke="currentColor"
